...
FAULT_PROFILES = {
    ...
    "gas_lock": {
        ...
        "description": "Gas pockets overwhelm pump stages — intake PSI crashes, vibration spikes",
        "color": "#f44336",
        "psi_range": (350, 750), "temp_range": (195, 245), "vib_range": (6.0, 12.0),
    },
    "sand_ingress": {
        "label": "Sand Ingress", "asset_class": "esp",
        "description": "Formation sand erodes pump impeller — vibration climbs progressively",
        "color": "#f9a825",
        "psi_range": (1280, 1580), "temp_range": (200, 240), "vib_range": (4.5, 9.5),
    },
    "motor_overheat": {
        "label": "Motor Overheat", "asset_class": "esp",
        "description": "Downhole cooling circulation reduced — motor winding temperature climbs",
        "color": "#ff6d00",
        "psi_range": (1300, 1560), "temp_range": (265, 295), "vib_range": (2.5, 4.5),
    },
    # ── Gas Lift Compressor Faults ────────────────────────────────────────────
    "valve_failure": {
        "label": "Valve Failure", "asset_class": "gas_lift",
        "description": "Check valve breaks — discharge pressure crashes, vibration spikes",
        "color": "#e53935",
        "psi_range": (450, 640), "temp_range": (165, 200), "vib_range": (8.0, 14.0),
    },
    "thermal_runaway": {
        "label": "Thermal Runaway", "asset_class": "gas_lift",
        "description": "Cooling degradation — discharge temperature climbs while pressure stays normal",
        "color": "#ff6f00",
        "psi_range": (940, 1040), "temp_range": (210, 248), "vib_range": (3.0, 5.5),
    },
    "bearing_wear": {
        "label": "Bearing Wear", "asset_class": "gas_lift",
        "description": "Progressive bearing degradation — frame vibration climbs over hours",
        "color": "#f9a825",
        "psi_range": (945, 1040), "temp_range": (163, 183), "vib_range": (7.5, 13.5),
    },
    # ── Mud Pump Faults ───────────────────────────────────────────────────────
    "pulsation_dampener_failure": {
        "label": "Pulsation Dampener Failure", "asset_class": "mud_pump",
        "description": "Dampener bladder ruptures — extreme vibration and pressure spikes",
        "color": "#b71c1c",
        "psi_range": (3800, 4600), "temp_range": (120, 158), "vib_range": (15.0, 28.0),
    },
    "valve_washout": {
        "label": "Valve Seat Washout", "asset_class": "mud_pump",
        "description": "High-velocity fluid erodes valve seat — discharge pressure slowly declines",
        "color": "#e65100",
        "psi_range": (1800, 2400), "temp_range": (115, 145), "vib_range": (5.0, 10.0),
    },
    "piston_seal_wear": {
        "label": "Piston Seal Wear", "asset_class": "mud_pump",
        "description": "Seal degradation — fluid temp rises, pressure slowly drops",
        "color": "#f57f17",
    ...
    "gearbox_bearing_spalling": {
        ...
        "description": "Metal-to-metal fatigue in gearbox — vibration signature climbs distinctively",
        "color": "#880e4f",
        "psi_range": (2850, 3060), "temp_range": (175, 222), "vib_range": (11.0, 20.0),
    },
    "hydraulic_leak": {
        "label": "Hydraulic Leak", "asset_class": "top_drive",
        "description": "Fluid loss — hydraulic system pressure drops progressively",
        "color": "#4a148c",
